...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateStudentMutationVariables = {id: number;data: BodyType<StudentInput>}
...
export const getPatchStudentUrl = (id: number,) => {
 ...
 */
export const patchStudent = async (id: number,
...
return customFetch<Student>(getPatchStudentUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
export const getPatchStudentMutationKey = () => ['patchStudent'] as const;

export const getPatchStudentMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchStudent>>, TError,PatchStudentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof patchStudent>>, TError,PatchStudentMutationVariables, TContext> => {

const mutationKey = getPatchStudentMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof patchStudent>>, PatchStudentMutationVariables> = (props) => {
          const {id,data} = props ?? {};

          return  patchStudent(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchStudentMutationVariables = {id: number;data: BodyType<StudentUpdate>}

    /**
 * @summary Partially update student
 */
export const usePatchStudent = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchStudent>>, TError,PatchStudentMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof patchStudent>>,
        TError,
        PatchStudentMutationVariables,
        TContext
      > => {
      return useMutation(getPatchStudentMutationOptions(options));
    }
